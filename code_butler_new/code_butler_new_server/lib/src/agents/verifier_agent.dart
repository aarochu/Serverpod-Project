...
class VerifierAgent extends BaseAgent {
  ...
  Future<List<AgentFinding>> analyze(
    ...
    // This method is required by BaseAgent but VerifierAgent uses verifyDocumentation instead
    // This is a placeholder - the orchestrator should call verifyDocumentation directly
    logInfo(session, 'Verifier agent analyze called for PR $pullRequestId');
    return [];
  }
