...
class PerformanceAgent extends BaseAgent {
  ...
  Future<List<AgentFinding>> analyze(
    ...
    // This method is required by BaseAgent but PerformanceAgent uses analyzePerformance instead
    // This is a placeholder - the orchestrator should call analyzePerformance directly
    logInfo(session, 'Performance agent analyze called for PR $pullRequestId');
    return [];
  }
