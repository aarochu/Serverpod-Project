...
class SecurityAgent extends BaseAgent {
  ...
  Future<List<AgentFinding>> analyze(
    ...
    // This method is required by BaseAgent but SecurityAgent uses scanFile instead
    // This is a placeholder - the orchestrator should call scanFile directly
    logInfo(session, 'Security agent analyze called for PR $pullRequestId');
    return [];
  }
