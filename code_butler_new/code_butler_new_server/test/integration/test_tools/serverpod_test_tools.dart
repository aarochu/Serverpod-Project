...
import 'package:code_butler_new_server/src/generated/review_notification.dart'
    as _i5;
import 'package:code_butler_new_server/src/generated/pull_request.dart' as _i6;
import 'package:code_butler_new_server/src/generated/repository.dart' as _i7;
import 'package:code_butler_new_server/src/generated/review_session.dart'
    as _i8;
import 'package:code_butler_new_server/src/generated/agent_finding.dart' as _i9;
import 'package:code_butler_new_server/src/generated/greetings/greeting.dart'
    as _i10;
import 'package:code_butler_new_server/src/generated/protocol.dart';
import 'package:code_butler_new_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _HealthCheckEndpoint healthCheck;

  late final _MetricsEndpoint metrics;

  late final _NotificationEndpoint notification;

  late final _PullRequestEndpoint pullRequest;

  late final _RepositoryEndpoint repository;
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    healthCheck = _HealthCheckEndpoint(
      endpoints,
      serializationManager,
    );
    metrics = _MetricsEndpoint(
      endpoints,
      serializationManager,
    );
    ...
    pullRequest = _PullRequestEndpoint(
      endpoints,
      serializationManager,
    );
    repository = _RepositoryEndpoint(
      endpoints,
      serializationManager,
    );
...
class _MetricsEndpoint {
  ...
  _i3.Future<Map<String, dynamic>> getRepositoryHealth(
    _i1.TestSessionBuilder sessionBuilder,
    int repositoryId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          methodName: 'getRepositoryHealth',
          parameters: _i1.testObjectToJson({'repositoryId': repositoryId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<Map<String, dynamic>> getTrends(
    _i1.TestSessionBuilder sessionBuilder,
    String period,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'period': period}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<List<Map<String, dynamic>>> getMostProblematicFiles(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'metrics',
            method: 'getMostProblematicFiles',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'metrics',
          methodName: 'getMostProblematicFiles',
          parameters: _i1.testObjectToJson({'repositoryId': repositoryId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
  ...
  _i3.Future<Map<String, dynamic>> getAgentEffectiveness(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'metrics',
            method: 'getAgentEffectiveness',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'metrics',
          methodName: 'getAgentEffectiveness',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
...
class _NotificationEndpoint {
  ...
  _i3.Future<List<_i5.ReviewNotification>> getNotifications(
    _i1.TestSessionBuilder sessionBuilder,
    String userId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i5.ReviewNotification>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _PullRequestEndpoint {
  _PullRequestEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _i3.Future<List<_i6.PullRequest>> listPullRequests(
    _i1.TestSessionBuilder sessionBuilder,
    int repositoryId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i6.PullRequest>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _RepositoryEndpoint {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i7.Repository>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i7.Repository?> getRepositoryByUrl(
    _i1.TestSessionBuilder sessionBuilder,
    String url,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
...
class _ReviewEndpoint {
  ...
  _i3.Future<_i8.ReviewSession> startReview(
    _i1.TestSessionBuilder sessionBuilder,
    int pullRequestId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'pullRequestId': pullRequestId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i8.ReviewSession>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i8.ReviewSession?> getReviewStatus(
    _i1.TestSessionBuilder sessionBuilder,
    int reviewSessionId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i9.AgentFinding>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Stream<String> watchReviewProgress(
    _i1.TestSessionBuilder sessionBuilder,
    int reviewSessionId,
  ) {
    ...
    _i1.callStreamFunctionAndHandleExceptions(
      () async {
        var _localUniqueSession =
            (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
              endpoint: 'review',
              method: 'watchReviewProgress',
            );
        var _localCallContext = await _endpointDispatch
            .getMethodStreamCallContext(
              createSessionCallback: (_) => _localUniqueSession,
              endpointPath: 'review',
              methodName: 'watchReviewProgress',
              arguments: {'reviewSessionId': reviewSessionId},
